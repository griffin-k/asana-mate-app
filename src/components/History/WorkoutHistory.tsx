...
const WorkoutHistory: React.FC = () => {
  ...
  // Fetch data from localStorage and format it
  ...
  // Fetch activity data on mount or filter change
  useEffect(() => {
  ...
  const monthData = activityData.filter(item => isSameMonth(item.date, currentMonth));
